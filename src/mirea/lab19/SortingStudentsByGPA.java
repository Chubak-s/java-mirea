...
public class SortingStudentsByGPA {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Ivan", "Ivanov", "Programmer", 1, "IKBO-03-23", 4.5));
        students.add(new Student("Peter", "Petrov", "AppliedMath", 2, "INBO-12-22", 4.2));
        students.add(new Student("Max", "Maximov", "Lawyer", 4, "RMFS-14-20", 4.8));
